...
const String = require("../../string/string-extension.js")
...
FFBE.queryWikiForUnit = function(search, callback) {
    wikiClient.getArticle(search, function (err, content, redirect) {
        ...
        wikiClient.parse(content, search, function (err, xml, images) {
            ...
            parseUnitOverview(info, tips, parameters, (fields, limited, rarity) => {
                callback(search, overview, imgurl, description, limited, rarity, fields);
            });
        });
    });
}
FFBE.queryWikiForEquipment = function(search, params, callback) {
...
FFBE.queryWikiForAbility = function(search, params, callback) {
...
FFBE.queryWikiWithSearch = function(search, callback) {
...
FFBE.queryWikiFrontPage = function(callback) {
